We need to know what voltage level each subsystem needs. We are assuming these will be either 12, 5 or 3.3V but if there are others we can see what we can do. 
